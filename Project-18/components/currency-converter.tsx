...
type ExchangeRates = {
  ...
  // In the Source Currency select Field
  const handleSourceCurrencyChange = (value: Currency): void => {
    setSourceCurrency(value);
  };

  // In the Target Currency select Field
