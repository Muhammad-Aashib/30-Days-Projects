...
type UserProfile = {
  ...
  // The Fetched User Repositories Data
  ...
  //Fecthing User Data from GitHub API
      ...
      <Card className="w-full max-w-3xl p-6 space-y-4 shadow-lg rounded-lg bg-white">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-gray-600">
            Search for a GitHub username and view their profile and repositories, search like: AsharibAli
          </CardDescription>
        </CardHeader>
