...
// Types for the Timer Status and Session Type
type TimerStatus = "idle" | "running" | "paused";
type SessionType = "work" | "break";

//Interface for PomoDoro State
interface PomodoroState {
  ...
  //Function to Handle Session Switch
  ...
  //Function to Handle Changes in Duration of Work and Break
              ...
              <AlertDialogContent className="w-full max-w-2xl p-4 md:p-6">
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    <strong>The Pomodoro Technique </strong>is a time management method that uses a timer to break work into intervals called Pomodoros. The Pomodoro timer is traditionally set for 25 minutes, but can be customized to fit your needs. The basic steps are:
                    <br /><br />
                    <ol>
                      <strong>
                    ...
                    <br />
                    <Button>
                      <a href="https://todoist.com/productivity-methods/pomodoro-technique" target="_blank" rel="noopener noreferrer">Click Here to Read more!</a>
                    </Button>
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
