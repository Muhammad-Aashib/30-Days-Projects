...
//Conversion Rates and Unit Types
const conversionRates: Record<string, Record<string, number>> = {
  ...
  export default function UnitConverter() {
    ...
    //State Hooks for Managing Input Value, Selected Units, and Converted Value
...
//Function to Convert the Input Value to the Select Output Unit
